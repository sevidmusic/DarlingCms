...
/**
 * Class CoreHtmlUserInterface. Defines an implementation of the IUserInterface
 * and IHtmlPage interfaces that extends the DOMDocument class. This implementation
 * is responsible for generating the html for the Darling Cms user interface.
 *
...
class CoreHtmlUserInterface extends DOMDocument implements IHtmlPage, IUserInterface
{
    ...
    /**
     * @var string The title of the html page generated by this CoreHtmlUserInterface
     *             implementation instance.
     */
    protected $title = 'Darling Cms';
    /**
     * @var IAppStartup $appStartup Local instance of an object that implements the
     *                  IAppStartup interface.
     */
    ...
    /**
     * CoreHtmlUserInterface constructor. Injects the IAppStartup instance used
     * by this object, and calls the IAppStartup implementation's startup() method.
     * Additionally, calls the setCssLinkTags() method, and the setJsScriptTags()
     * method in order to populate the $headCssLinksTags property's array and the
     * $headScriptsTags property's array, respectively.
     *
     * @param IAppStartup $appStartup Instance of an object that implements the
     *                                IAppStartup interface.
     *
     * @param string $title The title to assign to the html page generated by this
     *                      CoreHtmlUserInterface implementation instance.
     *
     * @see IAppStartup::startup()
     * @see CoreHtmlUserInterface::setCssLinkTags()
     * @see CoreHtmlUserInterface::setJsLinkTags()
     */
    public function __construct(IAppStartup $appStartup, string $title = '')
    {
        parent::__construct();
    ...
    public function getHead(): string
    {
        ...
        return '<head><title>' . $this->title . '</title>' . $viewport . implode('', $this->headCssLinksTags) . implode('', $this->headScriptsTags) . '</head>';
    }
     ...
     *
     * Note: The $headScriptsTags property's array is imploded and appended to the end
    ...
    /**
     * Set the link tags for any css file paths returned by the IAppStartup
     * implementation's getCssPaths() method in the $headCssLinks property's
     * array.
     *
    ...
    /**
     * Set the script tags for any javascript file paths returned by the IAppStartup
     * implementation's getJsPaths() method in the $headScriptsTags property's array.
     *
    ...
    private function setJsLinkTags(): void
    {
        ...
        foreach ($jsPaths as $jsPath) {
            /**
             * Html comment added between script tags to prevent formatting from
             * replacing closing script tag with />, this is a hack till a workaround
             *  is found.
             */
    ...
    /**
     * Prep html for formatting. This method transforms a string of html that spans
     * multiple lines into a single line of html, removing excessive or unnecessary
     * whitespace, tabs, and new lines. It also inserts the PRESERVE_EMPTY_ELEMENTS
     * string between occurrences of ></ in order to insure empty elements are
     * preserved when html is processed by the formatHtml() method.
     *
     ...
     * @credit Html formatting solution using DOMDocument::saveXml() instead
     *         of DOMDocument::saveHtml() was adopted from an answer found
     *         on Stack Overflow:
    ...
    private function formatHtml(string $html)
    {
        ...
        /*
         * Return the formatted html by passing the value returned by saveXML() to the
         * cleanHtml() method, and returning the value returned by cleanHtml().
         * Note: The DOMDocument::saveXml() method is used to insure elements are
         *       formatted with tabs, not just new lines.
         *
         * For further explanation of why the DOMDocument::saveXml() method is used
         * instead of the DOMDocument::saveHtml() method see the stack overflow
         * answer provided at the following url:
         * @see https://stackoverflow.com/questions/768215/php-pretty-print-html-not-tidy
         */
    ...
    /**
     * This method removes the unnecessary strings added by the DOMDocument::saveXML()
     * method and the CoreHtmlUserInterface::prepHtml() method. This method will also
     * remove empty lines.
     *
    ...
    private function cleanHtml(string $html): string
    {
        ...
        /**
         * Solution for removing empty lines via preg_replace() found on stack overflow
