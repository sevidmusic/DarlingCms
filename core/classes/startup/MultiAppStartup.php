...
class MultiAppStartup implements IAppStartup
{
    ...
    /**
     * MultiAppStartup constructor. Injects the provided AppInfo implementation instance.
     * @param AppInfo $appInfo Instance of an AppInfo object.
     */
    ...
    {
        return array(
            self::APP_DIR_PATH_KEY => $this->appInfo->getAppDirPath(),
            self::APP_CONFIG_PATHS_KEY => $this->appInfo->getAppConfigPaths(),
    ...
    /**
     * Handles startup logic. Calls the startup() method of each IAppStartup implementation provided
     * by the injected AppInfo implementation instance.
    ...
    /**
     * Handles shutdown logic. Specifically, calls the shutdown() method of each IAppStartup implementation provided
     * by the injected AppInfo implementation instance.
    ...
    /**
     * Handles restart logic. Specifically, calls the restart() method of each IAppStartup implementation provided
     * by the injected AppInfo implementation instance.
